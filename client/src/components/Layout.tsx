    ...
    <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground">
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[9px] font-medium text-sidebar-foreground/90 whitespace-nowrap">Bridging Offenders & Guardians Using Support</p>
          <p className="text-[9px] italic text-sidebar-foreground/60 mt-0.5 leading-tight">“Track cases. Stay informed. Take control.”</p>
        </div>
      </div>
